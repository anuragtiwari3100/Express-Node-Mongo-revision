...
exports.localFileUpload = async(req,res) =>{
    try{
        ...
        //  console.log("File has found",file);
         ...
         //creating  a path where files have to store   on the server
        ...
        console.log("Not able to upload  the file to the server");
        console.log(error);
    }
}
...
exports.imageUpload = async (req, res) => {
    console.log("Printing the data inside the red corridor");
    ...
    try {
        ...
        // 3. Upload to Cloudinary ✅ await here
        const response = await uploadFileToCloudinary(file, "Abhisek");
    ...
    console.log("Printing the data inside the red corridor (end)");
};



exports.videoUpload = async (req, res) => {
    console.log("trying to upload the  vi");
    try {
        // Fetch Data 
        const { name, tags, email } = req.body;
